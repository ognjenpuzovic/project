...
#define NUM_LEDS 120        // Velicina koriscene trake
#define updateLEDS 3        // Koliko dioda se updejtuje po sekundi
#define COLOR_SHIFT 1000  // Vreme izmedju promene boje (u ms)
CRGB leds[NUM_LEDS];        // niz led dioda koji obradjujemo

#define RefreshRate 10       // Koliko cesto se cita zvuk (u ms)
// Input/Output
